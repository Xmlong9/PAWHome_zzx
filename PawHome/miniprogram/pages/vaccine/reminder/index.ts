...
Page({
  ...
  async onLoad(options: any) {
    ...
    const petName = typeof options?.petName === "string" ? safeDecode(options.petName) : "";
    const vaccineName = typeof options?.itemName === "string" ? safeDecode(options.itemName) : "";
    const hospitalName = typeof options?.storeName === "string" ? safeDecode(options.storeName) : "";
    const date = typeof options?.date === "string" ? safeDecode(options.date) : "";
    const time = typeof options?.time === "string" ? safeDecode(options.time) : "";
    this.setData({
      appointmentId,
      petName,
      vaccineName,
